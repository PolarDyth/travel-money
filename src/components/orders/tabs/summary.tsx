...
import { Calendar, CheckCircle2, Clock, Package, ShoppingBag, User, X, XCircle } from "lucide-react";
...
export default function OrderSummary( { order, onStatusChange }: OrderSummaryProps) {
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">£{Number(order.totalSterling)}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">{new Date(order.collectionDate).toDateString()}</span>
                    </div>
                    <div className="flex items-center gap-2">
